...
void main() {
  ...
  //from.x += transverseSpeed*(1.0)*cos(0.1*time) + 0.001*time;
  //from.y += transverseSpeed*(1.0)*sin(0.1*time) +0.001*time;
  ...
  for (int r=0; r<volsteps; r++) {
    ...
    //backCol2 += 0.25 * vec3(t3 * t3 * t3) * fade;
